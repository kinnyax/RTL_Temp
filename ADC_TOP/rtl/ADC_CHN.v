...
module ADC_CHN(
    ...
    output wire                             fifo_overflow_evt_afe                       ,
...
wire                                        sysref_error_evt_afe                        ;
wire                                        sysref_seen_evt_afe                         ;
wire [1:0]                                  disparity_evt_jesd                          ;
wire [1:0]                                  notintable_evt_jesd                         ;
wire                                        data_drop_evt_afe                           ;
wire                                        ddc_abort_afe                               ;
wire                                        ddc_admit_ok_afe                            ;
wire                                        ddc_admit_ok_adc                            ;
...
assign ddc_admit_ok_afe = ~ddc_abort_afe;
...
CHN_SYNC chn_sync(
    ...
    .link_error_evt                     (link_error_evt_jesd                         ),
    .sysref_error_evt                   (sysref_error_evt_afe                         ),
    .sysref_seen_evt                    (sysref_seen_evt_afe                         ),
    .disparity_evt                      (disparity_evt_jesd                          ),
    .notintable_evt                     (notintable_evt_jesd                         ),
    .fifo_full_afe                      (fifo_full_afe                               ),
    .data_drop_evt_afe                  (data_drop_evt_afe                           ),
...
async_fifo #(
    ...
    .full                               (fifo_full_afe                                 ),
    .empty                              (fifo_rd_empty                                 ),
    .overflow                           (fifo_overflow_evt_afe                         ),
    .underflow                          (                                              ),
    .wlevel                             (fifo_wr_level                                 ),
    .rlevel                             (fifo_rd_level                                 )
);
